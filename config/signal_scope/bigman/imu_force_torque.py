...
addSignal('MICROSTRAIN_INS2',msg.utime, msg.accel[0])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.accel[1])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.accel[2])

addSignalFunction('MICROSTRAIN_INS2', accelNormFunction)
...
addSignal('MICROSTRAIN_INS2',msg.utime, msg.gyro[0])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.gyro[1])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.gyro[2])
...
addSignal('FORCE_TORQUE',msg.utime, msg.sensors[0].force[0])
addSignal('FORCE_TORQUE',msg.utime, msg.sensors[1].force[0])
addSignal('FORCE_TORQUE',msg.utime, msg.sensors[0].force[1])
addSignal('FORCE_TORQUE',msg.utime, msg.sensors[1].force[1])
...
# orientation plot
addPlot(timeWindow=30, yLimits=[1, 2])
...
addSignal('MICROSTRAIN_INS2',msg.utime, msg.quat[0])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.quat[1])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.quat[2])
addSignal('MICROSTRAIN_INS2',msg.utime, msg.quat[3])
